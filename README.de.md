...
[![Themes](https://img.shields.io/badge/themes-40-fbbf24)](#galerie)

Retro-Farbthemes fuer [Textual](https://textual.textualize.io/) TUI-Anwendungen.

40 sorgfältig gestaltete Themes, inspiriert von klassischen Computern, Betriebssystemen, historischen Taucheruhren, Comic-Farbschemata, 80er-Pastell, Spielberg-Ära-Kino, Motorsport-Lackierungen, Reggae-Roots und Mafia-Noir-Kino.
...
Durchstöbere alle 40 Themes interaktiv im mitgelieferten Storybook.
...
class MyApp(App):
    def __init__(self):
        super().__init__()
        register_all(self)       # registriert alle 40 Themes
...
from textual_themes import (
    ...
    # Sammlungen
    RETRO_THEMES,          # list[Theme] — alle 40 Themes
