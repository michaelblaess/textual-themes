/* textual-themes / GitHub Pages carousel
   Vanilla JS. Theme list mirrors RETRO_THEMES (alphabetical) in themes.py. */
(function () {
  "use strict";

  const THEMES = [
    { slug: "ascot",            name: "Ascot — Racing Green with Yellow, Silver & Beige Text",    dark: true  },
    ...
    { slug: "corleone",         name: "Corleone — Cold Noir Bronze & Steel",                      dark: true  },
    ...
    { slug: "marley",           name: "Marley — Reggae Black, Green, Gold & Red",                 dark: true  },
    ...
    { slug: "platoon",          name: "Platoon — Jungle Olive Drab & Khaki",                      dark: true  },
